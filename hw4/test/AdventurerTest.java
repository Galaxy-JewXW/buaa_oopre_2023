...
public class AdventurerTest {
    ...
    public void fuckYou() {
        Adventurer adventurer = new Adventurer(12, "sb");
        Adventurer adventurer1 = new Adventurer(13, "apple");
        adventurer.addEquipment(13, "ba", 1);
        adventurer.carryEquipment(13);
        adventurer.carryEquipment(14);
        adventurer.fuckYou(adventurer1, "ba");
        adventurer.fuckYou(adventurer1, "sb");
        assertEquals(499, adventurer1.getHitPoint());
    }

    @Test
    public void fuckEveryone() {
        Adventurer a1 = new Adventurer(1, "a");
        Adventurer a2 = new Adventurer(2, "b");
        Adventurer a3 = new Adventurer(3, "c");
        a1.addEquipment(13, "ba", 1);
        a1.carryEquipment(13);
        HashMap<Integer, Adventurer> map = new HashMap<>();
        map.put(1, a1);
        map.put(2, a2);
        map.put(3, a3);
        a1.fuckEveryone(map, "ba");
        a2.fuckEveryone(map, "ba");
        assertTrue(a1.getHitPoint() == 500 && a2.getHitPoint() == 499);
    }
}